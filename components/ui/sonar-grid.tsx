// Sonar Grid component supplied via the user's 21st.dev integration prompt.
"use client"
...
const MAX_DPR = 2
const TAU = Math.PI * 2
const DEFAULT_PING_AREA: [number, number, number, number] = [0.15, 0.2, 0.85, 0.8]
